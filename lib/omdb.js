...
// which can burst enough simultaneous connections to hit a dropped
// connection (ECONNRESET) rather than a clean error response. Retry with
// backoff instead of silently treating that as "no match".
